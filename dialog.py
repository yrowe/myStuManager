...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.widget.setGeometry(QtCore.QRect(50, 50, 241, 271))
        ...
        self.lineEdit_score = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_score.setObjectName("lineEdit_score")
        self.horizontalLayout.addWidget(self.lineEdit_score)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_6.setText(_translate("Dialog", "成绩"))
